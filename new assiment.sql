...
SELECT first_name
FROM employees
WHERE YEAR(hire_date) IN (1987, 1989);


SELECT first_name
FROM employees
WHERE YEAR(hire_date) BETWEEN 1987 AND 2000;
...
SELECT SUM(salary) AS total_salary_spent, COUNT(*) AS employee_count
FROM employees;
...
SELECT MAX(salary) AS maximum_salary, COUNT(*) AS employee_count
FROM employees;
